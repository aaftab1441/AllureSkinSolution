...
using BA.AllureSkinsolution.Configuration;
...
namespace BA.AllureSkinsolution.Adapters
{
    public class ContactUsAdapter
    {
        ...
        public async Task<bool> CreateAndSendEmail(ContactUsModel contactUs)
        {
            ...
            try
            {
                ...
                EmailAddressModel fromAddress = new EmailAddressModel(contactUs.ZEq6Upn5d6, contactUs.Y9xItYxUUA);
        ...
        {
            string _body = body.Replace(@"[Name]", contact.ZEq6Upn5d6)
                .Replace(@"[Email]", contact.Y9xItYxUUA)
                .Replace(@"[Phone]", contact.K7pmWqXbaV)
                .Replace(@"[Referral]", contact.kxCJgcNxcc)
                .Replace(@"[Comments]", contact.ZPqL6w6Ao3)
